...
// // SubScreen::SubScreen(nanogui::Screen* screen, Experiment& data) : experiment(data), screen(screen) {
...
// }
//
// // bool SubScreen::checkInitialized(bool verbose) {
// //     if (experiment.estimator == nullptr) {
// //         if (verbose) cout << "ERROR: Estimator not initialized" << endl;
// //         return false;
// //     }
// //     if (experiment.extinction == nullptr) {
// //         if (verbose) cout << "ERROR: Extinction not initialized" << endl;
// //         return false;
// //     }
// //     return true;
// // }
// //
// // bool SubScreen::checkCompatibilities(bool verbose) {
// //     if (!experiment.estimator->isCompatible(experiment.extinction->getType())) {
// //         if (verbose) cout << "ERROR: Estimator not compatible with Extinction" << endl;
// //         return false;
// //     }
// //     return true;
// // }
